...
I **design and build** cloud-native **Quality & DevSecOps platforms** → converting **testing, security & CI/CD signals** into **risk-aware GO / NO-GO release decisions** for **Kubernetes-based systems**.
