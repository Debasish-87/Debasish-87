...
I design and build **cloud-native Quality & DevSecOps platforms** that convert UI, API, security, and CI/CD signals into **risk-aware release decisions** for Kubernetes-based systems.
